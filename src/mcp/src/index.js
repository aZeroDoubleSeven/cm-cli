...
server.registerTool(
  "create-with-template",
  {
    ...
    description:
      "通过选择预设模板快速创建uni-app项目，无需自定义配置。提供多种预设模板，包括vitesse、wot-starter、零售模板等，适合不同场景的快速启动。",
...
server.registerTool(
  "create-custom",
  {
    ...
    description:
      "通过自定义配置创建uni-app项目，可自由选择TypeScript、ESLint、插件、模块、UI库等。适合需要精细化配置的项目需求，提供完整的定制化能力。",
